...
* LyricsFluencer-BackEndLite - A Express Backend with static HTML exported files generated by the NextJS Backend, in order to upload a light production server
